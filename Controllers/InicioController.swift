...
class InicioController: UIViewController, URLSessionDelegate, URLSessionTaskDelegate, URLSessionDataDelegate, UIApplicationDelegate, AVAudioPlayerDelegate {
    ...
    {
        let storeInfoURL: String = "http://itunes.apple.com/lookup?bundleId=com.nvezlnmgcz.500taxi.app"
...
//             let LoginController = MainStoryboard.instantiateViewController(withIdentifier: "LoginView") as! LoginController
//             let RootNaviController: UINavigationController = MainStoryboard.instantiateViewController(withIdentifier: "LoginNavigationController") as! UINavigationController
//             RootNaviController.setViewControllers([LoginController], animated: true)
//             RootNaviController.modalTransitionStyle = .crossDissolve
//            RootNaviController.modalPresentationStyle = .fullScreen
//             self.present(RootNaviController, animated: true, completion: nil)
    }
    ...
    @IBAction func CompartirApp(_ sender: Any) {
        if let name = URL(string: "itms://itunes.apple.com/us/app/apple-store/id1482729935?mt=8") {
